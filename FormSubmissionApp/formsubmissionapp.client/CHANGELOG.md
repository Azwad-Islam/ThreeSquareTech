...
- Create Angular project with ng: `ng new formsubmissionapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`formsubmissionapp.client.esproj`).
